class Disciplina:
  ...
  def __init__(self):
    ...
    self.__mediaparcial, self.__mediafinal = 0, 0
  ...
  def set_n3(self, n3):
    if n3 >= 0 and n3 <= 100: self.__n1 = n3
    else: raise ValueError()
  ...
  def get_mediafinal(self):
    return self.__mediafinal

  def get_mediaparcial(self):
    return self.__mediaparcial
  def calc_media_parcial(self):
    self.__mediaparcial = (self.__n1 * 2 + self.__n2 * 2 + self.__n3 * 3 +
                  self.__n4 * 3) / 10
  ...
  def calc_media_final(self):
    ...
    if self.__mediaparcial >= 60:
      self.__mediafinal = self.mediaparcial
    else:
      self.mediafinal = (self.media + self.__npfinal) / 2
...
class UI:
  ...
  def main():
    ...
    print(
      f'Disciplina: {x.get_disciplina}\nMédia Parcial: {x.get_mediaparcial}\nMédia Final: {x.get_mediafinal}'
    )
